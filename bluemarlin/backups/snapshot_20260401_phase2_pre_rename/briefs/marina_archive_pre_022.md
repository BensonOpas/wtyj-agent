# ARCHIVE_PRE_022 — State as of Brief 021
# This file is a read-only snapshot of source files immediately before
# Brief 022 (client.json schema + config_loader.py) is executed.
# Do not edit this file. It exists for rollback reference only.
# Archived: 2026-03-05

## bluemarlin/src/email_poller.py — State as of Brief 021
...
## bluemarlin/src/calendar.js — State as of Brief 021
