...
set -e
TARGET="${1:-all}"   # bluemarlin | staging | adamus | consulta-despertares | all
...
case "$TARGET" in
  all)
    DIRS="/root/clients/bluemarlin /root/clients/adamus /root/clients/consulta-despertares /root/clients/unboks /root/clients/wibrandt"
    ;;
...
sleep 10
for p in 8001 8002 8103 8004 8100 9001; do
