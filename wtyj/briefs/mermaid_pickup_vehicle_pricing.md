...
**Status:** Tested; deployment pending | **Files:** tenant catalog/version, catalog pricing helper, monetary snapshot, guest presentation, understanding/workflow, PDF labels, tests, runtime overlay | **Depends on:** one-page quote release 2eb3709 | **Blocks:** correct car/van pricing
