...
_DOSSIER_MESSAGES = {
    "en": {
        ...
        "documents_direct": "Great — your car is available. I’ll guide you through the remaining steps one at a time. Will you use a passport or an ID card for your reservation?",
    ...
    "nl": {
        ...
        "documents_direct": "Prima — je auto is beschikbaar. Ik begeleid je stap voor stap door het vervolg. Gebruik je een paspoort of identiteitskaart voor je reservering?",
    ...
    "pap": {
        ...
        "documents_direct": "Hopi bon — bo outo ta disponibel. Mi ta guia bo paso pa paso. Bo ta usa pasport òf karta di identidat pa bo reservashon?",
