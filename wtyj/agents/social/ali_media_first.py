...
_COPY = {
    "en": {
        ...
        "intro_many": "Swipe through the cars, then choose one in the chat.",
    ...
    "nl": {
        ...
        "intro_many": "Veeg door de auto's en kies er daarna één in de chat.",
    ...
    "pap": {
        ...
        "intro_many": "Pasa dor di e outonan, despues skoge un den e chat.",
    ...
    "de": {
        ...
        "intro_many": "Wischen Sie durch die Autos und wählen Sie dann eines im Chat aus.",
