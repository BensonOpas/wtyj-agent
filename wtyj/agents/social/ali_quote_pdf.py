...
LABELS = {
    ...
    "es": {
        "title": "Cotización oficial de alquiler de auto",
        "quote": "Cotización",
        "customer": "Cliente",
        "vehicle": "Vehículo",
        ...
        "charges": "Desglose de cargos",
        "description": "Descripción",
        "quantity": "Cant.",
        "total": "Total",
        "per_day": "por día de alquiler",
        "per_rental": "por alquiler",
        "days_suffix": "días",
        "grand_total": "Importe total de la cotización",
        "deposit_included": "Incluye un depósito de seguridad reembolsable de {amount}.",
        "rental_total": "Cargos de alquiler",
        "deposit": "Depósito de seguridad reembolsable",
        "issued": "Emitida",
        "expires": "Válida hasta",
        "validity": "Esta cotización es válida durante {hours} horas.",
        "availability": "Sujeta a la confirmación final de disponibilidad del vehículo.",
        "reply": "Responde por WhatsApp para aceptar esta cotización o hacer una pregunta.",
    },
}
